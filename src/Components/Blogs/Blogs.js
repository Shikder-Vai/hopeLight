    ...
    <div>
      <div>
        <div className="my-5 p-6">
          <h1 className=" text-2xl text-white bg-contain p-2 font-bold bg-sky-500">
            How will you improve the performance of a react application??
          </h1>
          <p className="text-lg font-semibold bg-sky-200 p-4">
            When it's necessary, keep component state local. <b p-4r />
            ...
            In React, ignore lazily loading pictures.
          </p>
        </div>
        <div className="my-5 p-6">
          <h1 className=" text-2xl text-white bg-contain p-2 font-bold bg-sky-500">
          ...
          <p className="text-lg font-semibold bg-sky-200 p-4">
            There are four different ways to manage a state in react
            application. <br />
            1. Local State. <br />
            2. Global State. <br />
            3. Server State <br />
        ...
        <div className="my-5 p-6">
          ...
          <p className="text-lg font-semibold bg-sky-200 p-4">
            Prototypal Inheritance is a feature of JS that allows you to add
            methods and properties to objects. <br />
            It's a method that allows one object to inherit the properties and
            methods of another. <br />
            Object getprototype of an object is traditionally used to get and
