            ...
            <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
              ...
              <form onSubmit={handleLogin}>
                ...
                <button
                  ...
                  class="px-7 py-3 btn text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3"
                >
                  {/* <!-- Facebook --> */}
                  <img class="w-3.5 h-3.5 mr-2" src={google} alt="" />
