      ...
      <div className="flex justify-center items-center">
        <div class="stats shadow -z-30">
          <div class="stat">
            ...
            <div class="stat-value text-purple-600">25.6K</div>
          ...
          <div class="stat">
            ...
            <div class="stat-title">Website Visitor</div>
            <div class="stat-value text-pink-600">2.6M</div>
            <div class="stat-desc">21% more than last month</div>
          </div>
          ...
          <div class="stat">
            ...
            <div class="stat-desc text-pink-600">26k+ Products Delivered </div>
          </div>
        </div>
      </div>
    </div>
